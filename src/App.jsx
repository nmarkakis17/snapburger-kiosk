...
export default function App() {
  ...
  return (
    <>
      {/* === FORCE the orbs to exist above the haze === */}
      <div
        className="orbs"
        aria-hidden="true"
        style={{
          position: 'fixed',
          inset: 0,
          zIndex: 1,            // haze is 0; app content is below at z=2 via CSS
          pointerEvents: 'none'
        }}
      >
        {/* Render 8 spans (you can raise this if you like) */}
        {Array.from({ length: 8 }).map((_, i) => (
          <span
            ...
            style={{
              ...
              background:
                i % 2 === 0
                  ? 'radial-gradient(circle at 40% 40%, rgba(14,165,233,.9), rgba(14,165,233,0) 68%)'
                  : 'radial-gradient(circle at 40% 40%, rgba(249,115,22,.9), rgba(249,115,22,0) 68%)',
              // scatter positions
              ...(i === 0 && { top: '6%', left: '6%' }),
              ...(i === 1 && { top: '18%', right: '8%' }),
              ...(i === 2 && { bottom: '14%', left: '12%' }),
              ...(i === 3 && { bottom: '10%', right: '14%' }),
              ...(i === 4 && { top: '50%', left: '40%' }),
              ...(i === 5 && { top: '8%', right: '35%' }),
              ...(i === 6 && { bottom: '24%', right: '42%' }),
              ...(i === 7 && { top: '32%', left: '70%' }),
              animation: 'floatY 18s ease-in-out infinite alternate, floatX 26s ease-in-out infinite alternate'
            }}
          />
        ))}
      </div>
